<template lang="md">
    # What Dinner? nu te downloaden in de App Store
    ...
    <a href="https://itunes.apple.com/nl/app/what-dinner/id1407394720">Download de app</a>
</template>
...
export default {
    layout: 'blog',
    head: {
        title: 'What Dinner? nu te downloaden in de App Store',
        meta: [
